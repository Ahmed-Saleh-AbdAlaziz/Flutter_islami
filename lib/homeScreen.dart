...
class _HomescreenState extends State<Homescreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        provider.isDarkMode()?
        Positioned.fill(child: Image.asset('assets/images/dark_bg.png',fit: BoxFit.cover,)):
        Positioned.fill(child: Image.asset('assets/images/light_bg.png',fit: BoxFit.cover,)),
        Scaffold(
          appBar: AppBar(
            elevation: 0,
          ...
          bottomNavigationBar: Theme(
            ...
            child: BottomNavigationBar(
              ...
              items: [
                ...
                BottomNavigationBarItem(icon: ImageIcon(AssetImage('assets/images/head_sebha_dark.png')),
  ...
  List<Widget> screenTap=[
    QuranTap(),HadethTap(),SebhaTap(),RadioTap(),Settings()
  ];
}
