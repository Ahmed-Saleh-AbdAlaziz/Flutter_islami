...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      children:
      [
      Text(AppLocalizations.of(context)!.language,style: Theme.of(context).textTheme.bodyLarge!.copyWith(
        fontSize: 25,
      )),
        Container(
        ...
        Text(AppLocalizations.of(context)!.mode,style: Theme.of(context).textTheme.bodyLarge!.copyWith(
          fontSize: 25,
        )
        ),
        Container(
          ...
          padding: EdgeInsets.all(10),
            ...
            child:InkWell(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
              Text(AppLocalizations.of(context)!.mode,style: Theme.of(context).textTheme.titleLarge,
                textAlign:TextAlign.start ,),
              Icon(Icons.keyboard_arrow_down_outlined,),
                        ],
                      ),
